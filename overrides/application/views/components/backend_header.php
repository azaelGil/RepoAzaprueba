...
<nav id="header" class="navbar navbar-expand-md navbar-dark">
    <div id="header-logo" class="navbar-brand">
        <!-- Modifica el logo aquí -->
        <img src="<?= base_url('assets/img/logo.png') ?>" alt="Authaz Systems">
        <span class="backend-brand-text">
            <!-- Modifica el título y subtítulo de la marca -->
            <span class="brand-title">Authaz Systems</span>
            <span class="brand-subtitle">Organízate</span>
        </span>
    </div>
