...
<head>
    ...
    <title><?= vars('page_title') ?? lang('account') ?> | Authaz Systems</title>

    <!-- ICONOS -->
    <link rel="icon" type="image/x-icon" href="<?= asset_url('assets/img/favicon.ico') ?>">
    <link rel="icon" sizes="192x192" href="<?= asset_url('assets/img/logo.png') ?>">

    <!-- CSS BASE DEL LAYOUT DE CUENTA -->
    ...
    <!-- Tema moderno global Authaz -->
    <link rel="stylesheet" href="<?= base_url('overrides/assets/css/authaz-theme.css') ?>">

    <!-- Custom global Authaz (igual que en booking_layout) -->
    <link rel="stylesheet" href="<?= base_url('overrides/assets/css/custom.css?v=999') ?>">

    <?php
    // 🔹 MUY IMPORTANTE: aquí sí usamos setting(), no vars()
    // Esto define las variables CSS de color (incluida --brand-color)
    if (function_exists('setting')) {
        component('company_color_style', [
