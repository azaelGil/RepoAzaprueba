...
/**
 * Color de marca del login / recovery
...
<style>
    /* ============================
     * Pantalla de RECUPERAR CLAVE Authaz
     * ============================ */
    ...
    /* Botón de recuperar con color de marca */
    .authaz-login-btn {
        border-radius: 999px;
...
<div class="authaz-login-shell">
    <div class="authaz-login-card">
        ...
        <div class="authaz-login-header">
            ...
            <div>
                ...
                <div class="authaz-login-subtitle">
                    Indica tu usuario y correo para regenerar una nueva contraseña.
                </div>
            </div>
        </div>
        ...
        <!-- Alertas (mismo selector .alert que el original) -->
        <div class="alert d-none authaz-login-alert mb-3"></div>

        <!-- Formulario de recuperación -->
        <form class="mb-5" id="recovery-form" autocomplete="off">
            <div class="mb-3 mt-4">
            ...
            <div class="mb-5">
                <label for="email" class="authaz-login-label">
                    <?= lang('email') ?>
                </label>
                <input
                    type="text"
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3 mb-1">
                <a href="<?= site_url('login') ?>" class="authaz-login-forgot user-login">
                    ← <?= lang('go_to_login') ?>
                </a>

                <!-- Mismo ID que el original: get-new-password -->
                <button type="submit" id="get-new-password" class="authaz-login-btn">
                    <i class="fas fa-paper-plane"></i>
                    <span><?= lang('regenerate_password') ?></span>
                </button>
            </div>
