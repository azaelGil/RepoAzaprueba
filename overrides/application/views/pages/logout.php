...
/**
 * Color de marca del login / logout
...
<style>
    /* ============================
     * Pantalla de LOGOUT Authaz
     *  - Mismo estilo que login / recovery
     * ============================ */
    ...
    .authaz-login-link-secondary {
        font-size: 0.85rem;
        text-decoration: none;
        color: <?= $brandColor ?>;
    }

    .authaz-login-link-secondary:hover {
...
<div class="authaz-login-shell">
    <div class="authaz-login-card">
        ...
        <div class="authaz-login-header">
            ...
            <div>
                ...
                <div class="authaz-login-subtitle">
                    Tu sesión se ha cerrado de forma segura. Puedes volver a acceder cuando quieras.
                </div>
            </div>
        </div>
        ...
        <div class="mb-4" style="position: relative; z-index: 1;">
            <p class="mb-2" style="font-size: 0.95rem; color: #4b5563;">
                Gracias por usar <?= vars('company_name') ?>.
            </p>
            <p class="mb-0" style="font-size: 0.85rem; color: #9ca3af;">
                Si compartes este equipo con otras personas, asegúrate de cerrar la ventana del navegador
                para mayor seguridad.
            </p>
        </div>

        <!-- Botones -->
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3 mb-2" style="position: relative; z-index: 1;">
            <a href="<?= site_url('login') ?>" class="authaz-login-btn">
                <i class="fas fa-sign-in-alt"></i>
                <span>Volver a iniciar sesión</span>
            </a>

            <a href="<?= site_url() ?>" class="authaz-login-link-secondary">
