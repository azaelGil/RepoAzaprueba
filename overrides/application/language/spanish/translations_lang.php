...
$lang['about_app'] = 'Acerca de la aplicación';
$lang['about_app_info'] = 'Esta aplicación permite a los clientes agendar citas a través de internet, además de sincronizar datos con Google Calendar para integrarse con otros servicios.';
$lang['current_version'] = 'Versión actual';
$lang['support'] = 'Soporte';
$lang['about_app_support'] = 'El grupo oficial de soporte está disponible en caso de encontrar inconvenientes. También podrás informar incidentes y contribuir al desarrollo del sistema.';
...
$lang['about_app_license'] = 'La aplicación se encuentra bajo licencia GPLv3. Todo uso del código implica aceptar los términos indicados por la licencia oficial.';
...
$lang['new_password_is'] = 'Su nueva contraseña para iniciar sesión es $password. Por favor, guarde este correo electrónico en caso de necesitar recuperar su contraseña nuevamente. También puede reemplazar esta contraseña por una de su preferencia en la página de Configuración.';
...
$lang['ea_update_success'] = 'La aplicación ha sido actualizada exitosamente';
...
$lang['cookie_notice_content'] = 'Contenido de Aviso de Cookies';
...
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API del sistema.';
...
$lang['company_logo_hint'] = 'El logotipo de la empresa se mostrará en muchos lugares de la aplicación, incluyendo la página de reservas y las notificaciones en correos electrónicos.';
$lang['company_color'] = 'Color corporativo';
$lang['company_color_hint'] = 'Elcolor corporativo se usará en múltiples sitios de la aplicación, así que elige el que más se adecúe a tu marca.';
...
$lang['webhooks_info'] = 'Los Webhooks permiten enviar notificaciones HTTP a aplicaciones externas cuando ocurre un evento en el sistema, como la creación o eliminación de una cita o un cliente.';
...
$lang['google_analytics_info'] = 'Google Analytics permite añadir automáticamente un código de seguimiento y etiquetas HTML a las páginas públicas para analizar todas las sesiones.';

$lang['matomo_analytics'] = 'Matomo Analytics';
$lang['matomo_analytics_info'] = 'Matomo Analytics permite añadir automáticamente el código de seguimiento a la página pública y monitorizar todas las sesiones de reserva.';

$lang['api'] = 'API';
$lang['api_info'] = 'La API permite interactuar mediante HTTP con los datos del sistema y crear integraciones personalizadas.';
...
$lang['future_booking_limit_hint'] = 'Define cuántos días hacia adelante se pueden hacer reservas.';
...
$lang['appointment_status_options_info'] = 'Define la lista de estados de citas que pueden usarse en el calendario.';
...
$lang['blocked_periods_hint'] = 'Define períodos donde las reservas estarán deshabilitadas para todos los proveedores.';
...
$lang['matomo_analytics_site_id'] = 'ID de sitio Matomo';
$lang['matomo_analytics_site_id_hint'] = 'Define el ID de sitio usado por Matomo.';
$lang['default_timezone'] = 'Zona horaria por defecto';
$lang['default_timezone_hint'] = 'Define la zona horaria usada en nuevos registros.';
$lang['default_language'] = 'Idioma por defecto';
$lang['default_language_hint'] = 'Define el idioma por defecto para nuevos registros.';
$lang['sync_method_prompt'] = '¿Qué método de sincronización desea usar?';
$lang['caldav_server'] = 'Servidor CalDAV';
$lang['caldav_connection_info_prompt'] = 'Ingrese la información de conexión al servidor CalDAV.';
$lang['connect'] = 'Conectar';

$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Permite conectar con un servidor LDAP e importar usuarios para que inicien sesión con sus credenciales del directorio.';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
$lang['user_dn'] = 'User DN';
$lang['base_dn'] = 'Base DN';
$lang['keyword'] = 'Keyword';
$lang['ldap_search_hint'] = 'Indique una palabra clave para buscar usuarios en el directorio LDAP.';
$lang['ldap_extension_not_loaded'] = 'La extensión LDAP de PHP no está cargada y es requerida para esta función.';
$lang['field_mapping'] = 'Mapeo de campos';
$lang['content'] = 'Contenido';
$lang['active'] = 'Activo';
$lang['user_imported'] = 'Usuario importado correctamente.';
$lang['import'] = 'Importar';
$lang['ldap_dn'] = 'LDAP DN';
$lang['role'] = 'Rol';
$lang['at_least_one_field_required'] = 'Al menos un campo debe establecerse como requerido.';
$lang['customer_is_already_booked'] = 'Este cliente ya tiene una cita en el periodo solicitado.';
$lang['fields'] = 'Campos';
$lang['invalid_credentials_provided'] = 'Credenciales inválidas, inténtelo nuevamente.';
